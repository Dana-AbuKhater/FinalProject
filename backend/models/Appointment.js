...
const AppointmentSchema = new mongoose.Schema({
  Appointment_id: { type: Number, required: false, unique: true }, // مفتاح أساسي، يجب أن يكون فريدًا
  user_id: { type: Number, required: true }, // مفتاح أجنبي يشير إلى جدول المستخدمين
  salon_id: { type: Number, required: true }, // مفتاح أجنبي يشير إلى جدول الصالونات
  service_id: { type: Number, required: true }, // مفتاح أجنبي يشير إلى جدول الخدمات
  ...
  status: {
    ...
    default: "Pending",
  }, // استخدام enum للقيم المحددة وقيمة افتراضية
